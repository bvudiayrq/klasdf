...
def execute_message_call(
    ...
    for open_world_state in open_states:
        ...
        print("execute_message_call,# tx_id:",next_transaction_id)
...
def execute_contract_creation(
    ...
    for open_world_state in open_states:
        next_transaction_id = tx_id_manager.get_next_tx_id()
        print("execute_contract_creation,# tx_id:",next_transaction_id)
...
def _setup_global_state_for_execution(
    ...
    print("work_list len",len(laser_evm.work_list))
...
def execute_transaction(*args, **kwargs):
    ...
    if kwargs["callee_address"] == "":
        ...
        print("execute_contract_creation end")
        return
